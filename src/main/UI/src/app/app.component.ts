 ...
 //     this.rooms=ROOMS;
      ...
      this.getWelcomeMessage().subscribe(
        welcome=>{
          ...
          this.welcomeEN = welcome[0];
          this.welcomeFR = welcome[1];
        }
      )
  ...
  /*mapRoom(response:HttpResponse<any>): Room[]{
    ...
    getWelcomeMessage(): Observable<any>{
      // @ts-ignore
      return this.httpClient.get(this.baseURL + '/welcome/message', {responseType: "json"})

    }

    getTime(): Observable<any>{
      return this.httpClient.get(this.baseURL + '/time/conversion', {responseType: "json"})
    }
  }
